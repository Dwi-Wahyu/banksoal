tinymce.init({
    selector: "textarea#aspek-dinilai",
    height: 250,
});
...
const form = document.getElementById("tambah-aspek");
...
form.addEventListener("submit", (e) => {
    e.preventDefault();
    let skorDiisi = 0;
    const aspekDinilai = tinymce.get("aspek-dinilai").getContent();
    ...
    const data = { aspekDinilai, inp0, inp1, inp2, skor0, skor1, skor2 };
    ...
    if (!aspekDinilai) {
        ...
        fetch(`/tulis-soal/tambah-aspek/${id}`, {
            method: "POST",
